...
class compilerTest(unittest.TestCase):
    ...
    def test_template_type(self):
        try:
            ...
            coloredPrint('\n  [compiler] × template type detect failed.', 'RED')
        else:
    ...
    def test_empty_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × empty template detect failed.', 'RED')
        else:
    ...
    def test_variable_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × variable template parse failed.', 'RED')
        else:
    ...
    def test_variable_with_expression_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × error tokenize variable with expression template.', 'RED')
        else:
    ...
    def test_variable_with_string_expression_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × error tokenize variable with string expression template.', 'RED')
        else:
    ...
    def test_block_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × block template parse failed.', 'RED')
        else:
    ...
    def test_comment_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × comments template parse failed.', 'RED')
        else:
    ...
    def test_raw_template(self):
        ...
        try:
            ...
            coloredPrint('\n  [compiler] × raw template parse failed.', 'RED')
        else:
